    ...
    <>
      ...
      <Card style={{ border: '1px solid #e8eaed', borderRadius: 12, boxShadow: '0 1px 4px rgba(0,0,0,0.06)' }} bodyStyle={{ padding: '16px 20px' }}>
        <div style={{ display: 'flex', gap: 10, alignItems: 'center', marginBottom: 16 }}>
          <div style={{ flex: 1 }} />
          <Button icon={<DownloadOutlined />} onClick={() => exportTableToCsv('items.csv', rules, columns)}>Export CSV</Button>
      ...
      <Form form={form} layout="vertical" onFinish={handleSubmit}>
        <div style={{ display: 'flex', gap: 32 }}>
          <div style={{ flex: 1, maxWidth: 560 }}>
            ...
            <Form.Item name="reorder_point" label={<Text style={{ fontWeight: 500, color: '#b45309' }}>Reorder Point</Text>} style={{ maxWidth: 200 }}>
              <InputNumber min={0} step={1} placeholder="Min stock level for alert" style={{ width: '100%' }} />
            </Form.Item>
      ...
      <div style={{ display: 'flex', gap: 24 }}>
        ...
        <div style={{ flex: '0 0 420px' }}>
          <Form form={form} layout="vertical">
            ...
            <div style={{ display: 'flex', gap: 12 }}>
              <Form.Item name="bom_unit" label={<Text style={{ fontWeight: 500 }}>BOM Unit</Text>} style={{ flex: 1 }}>
                <Select options={UNIT_OPTIONS} showSearch filterOption={(i, o) => (o?.label ?? '').toLowerCase().includes(i.toLowerCase())} disabled={!editing} />
              </Form.Item>
              <Form.Item name="reorder_point" label={<Text style={{ fontWeight: 500, color: '#b45309' }}>Reorder Point</Text>} style={{ flex: 1 }}>
                <InputNumber min={0} step={1} placeholder="Min stock level" disabled={!editing} style={{ width: '100%' }} />
              </Form.Item>
            </div>
            <Form.Item name="sku_group_tags" label={<Text style={{ fontWeight: 500 }}>Sku Group Tags</Text>}>

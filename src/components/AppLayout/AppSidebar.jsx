    ...
    children: [
      ...
      // ── Production (SubMenu) ───────────────────────
      {
        ...
        children: [
          ...
          { key: 'm-ctq',              label: 'Critical To Quality', permission: 'production-quality-read' },
        ],
      },
      // ── Planning (SubMenu) ─────────────────────────
      {
...
const getNavState = (pathname) => {
  ...
  if (pathname.startsWith('/masters/production/ctq'))            return { selected: 'm-ctq',        open: ['masters', 'grp-production'] };
  // Inventory sub-group
